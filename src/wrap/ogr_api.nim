...
export cpl_minixml
export ogr_core
#import wrap/raw/cpl_progress
#import wrap/raw/cpl_minixml
#import wrap/raw/ogr_core
...
proc createFromWkb*(a1: pointer; a2: OGRSpatialReferenceH;
...
proc createFromFgf*(a1: pointer; a2: OGRSpatialReferenceH;
...
proc importFromWkb*(a1: OGRGeometryH; a2: pointer; a3: cint): OGRErr {.stdcall,
...
proc isValid*(a1: OGRGeometryH): cint {.stdcall, importc: "OGR_G_IsValid",
    dynlib: dynlibogr_api.}
proc makeValid*(a1: OGRGeometryH): OGRGeometryH {.stdcall,
    importc: "OGR_G_MakeValid", dynlib: dynlibogr_api.}
...
proc swapXY*(hGeom: OGRGeometryH) {.stdcall, importc: "OGR_G_SwapXY",
                                       dynlib: dynlibogr_api.}
...
proc setFieldStringList*(a1: OGRFeatureH; a2: cint; a3: CSLConstList) {.stdcall,
...
proc setFieldBinary*(a1: OGRFeatureH; a2: cint; a3: cint; a4: pointer) {.stdcall,
